...
Map my cleaning business: one booking, from enquiry to paid. No tool or
integration recommendations -- I just want the map. Here are all my answers
up front, so don't ask me anything: build it, check it, draw the open
questions and render it.
...
Keep everything in one temp folder.
