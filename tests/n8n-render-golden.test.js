...
//
// Rebaselined again for CTO-M1-05 (a note connector drawn straight
// through an unrelated node). That finding, too, was raised against this
...
test('renderMap(Medusa) is byte-identical to the CTO-M1-05 baseline', async () => {
